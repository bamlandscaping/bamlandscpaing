...
export default function Footer() {
  ...
  return (
    <footer className="bg-bam-dark text-white/85 py-10">
      <div className="max-w-[1200px] mx-auto px-5">
        <div className="flex items-center justify-between flex-wrap gap-4 max-md:flex-col max-md:text-center">
          ...
          <div className="flex gap-6 flex-wrap max-md:justify-center">
            {navLinks.map((link) => (
              <a
                key={link.key}
                href={link.href}
                className="text-sm text-white/80 transition-colors duration-300 hover:text-bam-green-light"
              >
                {t(link.key)}
              </a>
            ))}
          ...
          <div className="flex gap-3">
            <a
              ...
              className="w-10 h-10 bg-white/[0.08] rounded-full flex items-center justify-center text-white/70 transition-all duration-300 hover:bg-bam-green hover:text-white"
            >
        ...
        <div className="mt-10 pt-8 border-t border-white/[0.08] flex items-center justify-center gap-4 max-md:flex-col max-md:text-center">
          ...
          <a
            ...
            className="w-10 h-10 bg-bam-green rounded-full flex items-center justify-center text-white transition-all duration-300 hover:bg-bam-green-light hover:scale-110"
